...
def read_file(filename):
    ...
    with open(filename, 'r') as f:
        ...
        bus_ids = [(ix, int(bus_id)) for ix, bus_id in enumerate(bus_ids_raw) if bus_id != 'x']
...
print(f"Time to wait: {min_time_to_wait}, bus_id: {min_bus_id}, product = {min_time_to_wait * min_bus_id}")
